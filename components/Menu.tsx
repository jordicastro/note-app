...
const Menu = () => {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        className="w-80 h-[70vh] dark:bg-[#252525]"
        align="end"
        alignOffset={8}
        forceMount
      >
        <ScrollArea className="w-80 h-full">
          <DropdownMenuItem>
            <div
              className="font-sans flex flex-col justify-center items-center w-24 h-auto p-2 rounded-md hover:bg-primary/10"
              role="button"
              onClick={(e) => {
                e.preventDefault();
                setCurrentFont("sans");
            ...
            <div key={index}>
              ...
              >
                <MenuItem
                  ...
                  dropdownTrigger={item.dropdownTrigger}
                  onClick={() => {}}
                />
              </DropdownMenuItem>
              {item.lastItem && (
